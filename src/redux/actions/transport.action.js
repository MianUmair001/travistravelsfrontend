...
export const createTransport =
  ...
  async (dispatch) => {
    try {
      ...
      const response = await axios.put(URL + endpoints.UPDATE_TRANSPORT_BY_ID + id, {
        name,
        modelName,
        description,
        transportType,
  ...
  export const getALlTransport = () => async (dispatch) => {
    ...
    try {
      const response = await axios.get( URL + endpoints.GET_ALL_TRANSPORT )
...
export const getTransportByName = (name) => async (dispatch) => {
  ...
  try {
    const response = await axios.get( URL + endpoints.GET_TRANSPORT_BY_NAME + name )
