...
import { getPlanByPlanName } from "../../../redux/actions/plan.action";



const Get_plan_by_name = (planName) => {
    const dispatch = useDispatch();
    const { planID, name, description, price, rooms } = useSelector(
      (state) => state.plan
    );
    dispatch(getPlanByPlanName(planName));
...
export default Get_plan_by_name
