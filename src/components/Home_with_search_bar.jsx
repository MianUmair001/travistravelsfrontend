        ...
        <div id="search_bar_container">
          <div className="container">
            <div className="search_bar">
              <span className="nav-facade-active" id="nav-search-in">
                <span id="nav-search-in-content">All tours</span>
                <span className="nav-down-arrow nav-sprite" />
                <select
                  title="Search in"
                ...
                >
                  <option value="All Tours" title="All Tours">
                    All Tours
                  </option>
                  <option value="Museums" title="Museums">
                    Museums
                  </option>
                  <option value="Tickets" title="Tickets">
                    Tickets
                  </option>
                  <option value="Hotels" title="Hotels">
                    Hotels
                  </option>
                  <option value="Restaurants" title="Restaurants">
                    Restaurants
                  </option>
                </select>
              </span>
              <div className="nav-searchfield-outer">
                <input
                  type="text"
                  autoComplete="off"
                  name="field-keywords"
...
export default Home_with_search_bar;
