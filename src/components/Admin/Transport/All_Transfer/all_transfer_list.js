...
const All_transfer_list = ({ history }) => {
  ...
  const transportStateList = useSelector(
    (state) => state.transports.transports
  );

  useEffect(async () => {
    if (transportStateList?.length === 0) {
      const transportListArray = await dispatch(getALlTransport());
      setTransportListShow(transportListArray);
      return transportListArray;
    } else {
      setTransportListShow(transportStateList);
    }
  }, [transportStateList, transportsListShow]);
                              ...
                              <ul className="add_info">
                                ...
                                <li>
                                  <div className="tooltip_styled tooltip-effect-4">
                                    ...
                                    <div className="tooltip-content">
                                      <h4>Pick up</h4> Hotel pick up or
                                      different place with an extra cost.
                                    </div>
                                  </div>
                                </li>
                                <li>
                                ...
                                <li>
                                  <div className="tooltip_styled tooltip-effect-4">
                                    ...
                                    <div className="tooltip-content">
                                      <h4>Pet allowed</h4> On request pet
                                      allowed.
                                    </div>
                                  </div>
                                </li>
                                <li>
                                  <div className="tooltip_styled tooltip-effect-4">
                                    ...
                                    <div className="tooltip-content">
                                      <h4>Baggage</h4> Large baggage drop
                                      available.
                                    </div>
                                  </div>
                                </li>
