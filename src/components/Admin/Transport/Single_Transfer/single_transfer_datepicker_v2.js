import React from 'react'
 ...
 const Single_transfer_datepicker_v2 = () => {
    return (
        <>
<div>
            ...
            <div className="row">
              <div className="col-sm-6">
                <div className="form-group">
                  ...
                  <input className="form-control booking_date" type="text" data-lang="en" data-large-mode="true" data-large-default="true" data-min-year={2017} data-max-year={2020} data-disabled-days="11/17/2017,12/17/2017" />
                </div>
              </div>
              <div className="col-sm-6">
                <div className="form-group">
                  <label><i className=" icon-clock" /> Time</label>
                  <input className="form-control booking_time" type="text" />
                </div>
              </div>
            </div>
            <div className="row">
...
export default Single_transfer_datepicker_v2