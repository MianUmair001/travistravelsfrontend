              ...
              <div className="col-sm-6">
                <div className="tour_container">
                  ...
                  <div className="tour_title">
                    ...
                    {/* End wish list*/}
                    <div
                      onclick="onHtmlClick('Historic', 0)"
              ...
              <div className="col-sm-6">
                <div className="tour_container">
                  ...
                  <div className="tour_title">
                    ...
                    {/* End wish list*/}
                    <div
                      onclick="onHtmlClick('Churches', 0)"
                      className="view_on_map"
                    >
                      View on map
                    </div>
              ...
              <div className="col-sm-6">
                <div className="tour_container">
                  ...
                  <div className="tour_title">
                    ...
                    {/* End wish list*/}
                    <div
                      onclick="onHtmlClick('Historic', 1)"
                      className="view_on_map"
                    >
                      View on map
                    </div>
              ...
              <div className="col-sm-6">
                <div className="tour_container">
                  ...
                  <div className="tour_title">
                    ...
                    {/* End wish list*/}
                    <div
                      onclick="onHtmlClick('Historic', 2)"
                      className="view_on_map"
                    >
                      View on map
                    </div>
              ...
              <div className="col-sm-6">
                <div className="tour_container">
                  ...
                  <div className="tour_title">
                    ...
                    {/* End wish list*/}
                    <div
                      onclick="onHtmlClick('Sightseeing', 0)"
                      className="view_on_map"
                    >
                      View on map
                    </div>
...
export default All_tours_map_listing;
