                      ...
                      <ul className="add_info">
                        <li>
                          <div className="tooltip_styled tooltip-effect-4">
                            ...
                            <div className="tooltip-content">
                              <h4>Schedule</h4>
                              <strong>Monday to Friday</strong> 09.00 AM - 5.30
                              PM
                              <br />
                        ...
                        <li>
                          <div className="tooltip_styled tooltip-effect-4">
                            ...
                            <div className="tooltip-content">
                              <h4>Transport</h4>
                              <strong>Metro: </strong>Musée du Louvre station
                              (line 1)
                              <br />
                              <strong>Bus:</strong> 21, 24, 27, 39, 48, 68, 69,
                              72, 81, 95
                              <br />
                            </div>
                          </div>
              ...
              >
                <div className="row">
                  <div className="col-lg-4 col-md-4">
                    ...
                    <div className="img_list">
                      <a href="single_tour.html">
                        <img src="img/tour_box_2.jpg" alt="Image" />
                        <div className="short_info">
                          <i className="icon_set_1_icon-44" />
                          Churches
                        </div>
              ...
              >
                <div className="row">
                  <div className="col-lg-4 col-md-4">
                    ...
                    <div className="img_list">
                      <a href="single_tour.html">
                        <img src="img/tour_box_4.jpg" alt="Image" />
                        <div className="short_info">
                          <i className="icon_set_1_icon-37" />
                          Walking tour
                        </div>
              ...
              >
                <div className="row">
                  <div className="col-lg-4 col-md-4">
                    ...
                    <div className="img_list">
                      <a href="single_tour.html">
                        <img src="img/tour_box_14.jpg" alt="Image" />
                        <div className="short_info">
                          <i className="icon_set_1_icon-28" />
                          Skyline tour
                        </div>
              ...
              >
                <div className="row">
                  <div className="col-lg-4 col-md-4">
                    ...
                    <div className="img_list">
                      <a href="single_tour.html">
                        <img src="img/tour_box_5.jpg" alt="Image" />
                        <div className="short_info">
                          <i className="icon_set_1_icon-44" />
                          Historic Building
                        </div>
