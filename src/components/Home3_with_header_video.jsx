        ...
        <section class="header-video">
          <div id="hero_video">
            <div class="intro_title">
              ...
              <a
                href="#"
                class="animated fadeInUp button_intro outline hidden-sm hidden-xs"
              >
                View Tickets
              </a>
              <a
                href="https://www.youtube.com/watch?v=Zz5cu72Gv5Y"
                class="video animated fadeInUp button_intro outline"
              >
                Play video
              </a>
            </div>
          ...
          <img
            ...
            data-video-src=""
            data-teaser-source="video/paris"
...
export default Home3_with_header_video;
