          ...
          <div className="row">
            <div className="col-lg-8 add_bottom_15">
              ...
              <div id="policy">
                ...
                <a
                  href="confirmation_restaurant.html"
              ...
              <div className="box_style_1">
                ...
                <table className="table table_summary">
                  <tbody>
                    ...
                    <tr>
                      <td>Day</td>
                      <td className="text-right">25/10/2015</td>
                    </tr>
                    <tr>
                      <td>Time</td>
                      <td className="text-right">7.30pm</td>
                    </tr>
                  </tbody>
                </table>
                <a className="btn_full" href="confirmation_restaurant.html">
                  Book now
                </a>
...
export default Booking_restaurant;
