...
const Single_hotel_working_booking = () => {
  return (
    <>
      <div>
        <section
                  ...
                  >
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                            className="date-pick form-control required"
                        ...
                        <div className="form-group">
                          ...
                          <div className="numbers-row">
                            <input
                              ...
                              defaultValue={1}
                              id="adults_hotel"
                              className="qty2 form-control required"
                              name="adults_hotel"
                            />
                          </div>
                        </div>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                            ...
                            name="name_hotel_booking"
                            id="name_hotel_booking"
                            type="text"
                          />
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input
                            className="form-control required"
                            name="last_hotel_name_booking"
                            id="last_hotel_name_booking"
                            type="text"
                          />
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <input
                        className="form-control required"
                        type="email"
                        name="email_hotel_booking"
                        id="email_hotel_booking"
                      />
                    </div>
                    <div
                      className="form-group"
                    ...
                    >
                      ...
                      <input
                        className="form-control required"
                        type="text"
                        name="phone_hotel_booking"
                        id="phone_hotel_booking"
                      />
                    </div>
                    <br />
	    ...
	    ?*/}
                  ...
                  <div className="text-center">
                    <p>
                      <i
                        ...
                        style={{ fontSize: "75px", color: "#83c99f" }}
                      />
                    </p>
                    <p>
                  ...
                  .= "\nCheck in: " . $_POST['check_in_hotel']; $message .=
                  "\nCheck out: " . $_POST['check_out_hotel']; $message .=
                  "\nAdults: " . $_POST['adults_hotel']; $message .=
                  "\nChildren: " . $_POST['children_hotels']; $message .=
                  "\nName: " . $_POST['name_hotel_booking']; $message .= "\nLast
                  name: " . $_POST['last_hotel_name_booking']; $message .=
                  "\nEmail: " . $_POST['email_hotel_booking']; $message .=
                  "\nTelephone: " . $_POST['phone_hotel_booking']; //Receive
                  Variable $sentOk = mail($to,$subject,$message,$headers);
                  //Confirmation page $user = "$mail"; $usersubject = "Thank You
                  - Booking summary from TravisTravels"; $userheaders = "From:
                  info@TravisTravels.com\n"; //Confirmation page WITH SUMMARY
                  $usermessage = "Thank you for your time, request successfully
...
export default Single_hotel_working_booking;
