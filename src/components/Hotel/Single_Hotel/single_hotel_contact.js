              ...
              <aside className="col-lg-4">
                ...
                <div className="box_style_1 expose">
                  ...
                  <form
                    ...
                    method="post"
                  >
                    <h3 className="inner">Contact us</h3>
                    <div className="row">
                      <div className="col-md-6">
				...
				?*/}
                  ...
                  {/*?php
								...
								$subject = "Message From TravisTravels";
                  ...
                  "\nLast name: " . $_POST['last_hotel_name_booking']; $message
                  .= "\nEmail: " . $_POST['email_hotel_booking']; $message .=
                  "\nTelephone: " . $_POST['phone_hotel_booking']; $message .=
                  "\nMessage: " . $_POST['message_contact']; //Receive Variable
                  $sentOk = mail($to,$subject,$message,$headers); //Confirmation
                  page $user = "$mail"; $usersubject = "Thank You from
                  TravisTravels"; $userheaders = "From: info@TravisTravels.com\n";
                  //Confirmation page WITH SUMMARY $usermessage = "Thank you for
                  your time, message sent!.\nWe will contact you
                  shortly!\n\n$message";
...
export default Single_hotel_contact;
